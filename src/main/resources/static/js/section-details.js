(function () {
  ...
  var PRM_DATA = {
    ...
    'MAN.5':  { title:'Risk Management', group:'Management Process Group', color:'#4527a0',
      purpose:'To identify, analyze, evaluate, treat, monitor, and communicate project risks to minimize their potential impact on project objectives.',
    ...
    'MAN.6':  { title:'Measurement', group:'Management Process Group', color:'#4527a0',
      purpose:'To establish and use appropriate measurement processes and indicators to support project monitoring, decision-making, and achievement of defined objectives.',
